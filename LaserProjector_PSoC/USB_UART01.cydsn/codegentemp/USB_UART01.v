...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=1600, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=VDAC8_x, CY_INSTANCE_SHORT_NAME=VDAC8_x, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=VDAC8_x, )
...
// OpAmp_v1_90(Mode=1, Power=1, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Opamp_y, CY_INSTANCE_SHORT_NAME=Opamp_y, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Opamp_y, )
...
// OpAmp_v1_90(Mode=1, Power=1, CY_COMPONENT_NAME=OpAmp_v1_90, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=Opamp_x, CY_INSTANCE_SHORT_NAME=Opamp_x, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=Opamp_x, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=2, Voltage=1600, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=VDAC8_y, CY_INSTANCE_SHORT_NAME=VDAC8_y, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=VDAC8_y, )
...
module top ;
    ...
    VDAC8_v1_90_2 VDAC8_x (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_72));
    defparam VDAC8_x.Data_Source = 0;
    defparam VDAC8_x.Initial_Value = 100;
    defparam VDAC8_x.Strobe_Mode = 0;

    OpAmp_v1_90_3 Opamp_y (
        .Vplus(Net_84),
        .Vout(Net_76),
        .Vminus(Net_99));
    defparam Opamp_y.Mode = 1;

    OpAmp_v1_90_4 Opamp_x (
        .Vplus(Net_72),
        .Vout(Net_70),
        .Vminus(Net_98));
    defparam Opamp_x.Mode = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("fe7f0fbb-6129-4a54-81ba-9dfdf6378bd0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    VDAC8_v1_90_5 VDAC8_y (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_84));
    defparam VDAC8_y.Data_Source = 0;
    defparam VDAC8_y.Initial_Value = 100;
    defparam VDAC8_y.Strobe_Mode = 0;

	wire [0:0] tmpOE__laser_state_net;
	wire [0:0] tmpFB_0__laser_state_net;
	wire [0:0] tmpIO_0__laser_state_net;
	wire [0:0] tmpINTERRUPT_0__laser_state_net;
	electrical [0:0] tmpSIOVREF__laser_state_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("52f31aa9-2f0a-497d-9a1f-1424095e13e6"),
		  ...
		  .width(1))
		laser_state
		 (.oe(tmpOE__laser_state_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__laser_state_net[0:0]}),
		  .io({tmpIO_0__laser_state_net[0:0]}),
		  .siovref(tmpSIOVREF__laser_state_net),
		  .interrupt({tmpINTERRUPT_0__laser_state_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__laser_state_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    Timer_v2_50_6 Poll_Timer (
        ...
        .tc(Net_114),
        .clock(Net_10));
    defparam Poll_Timer.CaptureCount = 2;
    defparam Poll_Timer.CaptureCounterEnabled = 0;
    defparam Poll_Timer.DeviceFamily = "PSoC5";
    defparam Poll_Timer.InterruptOnCapture = 0;
    defparam Poll_Timer.InterruptOnTC = 1;
    defparam Poll_Timer.Resolution = 24;
    defparam Poll_Timer.SiliconRevision = "0";
    ...
    Timer_v2_50_7 Fire_Timer (
        ...
        .tc(Net_191),
        .clock(Net_10));
    defparam Fire_Timer.CaptureCount = 2;
    defparam Fire_Timer.CaptureCounterEnabled = 0;
    defparam Fire_Timer.DeviceFamily = "PSoC5";
    defparam Fire_Timer.InterruptOnCapture = 0;
    defparam Fire_Timer.InterruptOnTC = 1;
    defparam Fire_Timer.Resolution = 16;
    defparam Fire_Timer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Push_Switch_net;
	wire [0:0] tmpIO_0__Push_Switch_net;
	wire [0:0] tmpINTERRUPT_0__Push_Switch_net;
	electrical [0:0] tmpSIOVREF__Push_Switch_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4c15b41e-e284-4978-99e7-5aaee19bd0ce"),
		  ...
		  .width(1))
		Push_Switch
		 (.oe(tmpOE__Push_Switch_net),
		  .y({1'b0}),
		  .fb({Net_196}),
		  .io({tmpIO_0__Push_Switch_net[0:0]}),
		  .siovref(tmpSIOVREF__Push_Switch_net),
		  .interrupt({tmpINTERRUPT_0__Push_Switch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Push_Switch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
